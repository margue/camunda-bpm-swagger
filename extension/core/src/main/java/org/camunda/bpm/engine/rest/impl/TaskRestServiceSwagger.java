    ...
    extends TaskRestServiceImpl
{
    ...
    @Path("/reportcandidate-group-count")
    @GET
    ...
    public Map getTaskGetVariablesGetVariables(
        @PathParam("id")
        @ApiParam("Parameter id")
        String id,
    ...
    public VariableValueDto getTaskGetVariablesGetVariable(
        @PathParam("id")
        @ApiParam("Parameter id")
        String id,
        @PathParam("varId")
    ...
    public Map getTaskGetFormVariables(
        @PathParam("id")
        @ApiParam("Parameter id")
        String id,
    ...
    public List getTaskGetIdentityLinks(
        @PathParam("id")
        @ApiParam("Parameter id")
        String id,
        @QueryParam("type")
    ...
    @Produces("application/json")
    @ApiOperation(value = "Get Variables", notes = "Operation Get Variables")
    public Map getTaskGetLocalVariablesGetVariables(
        @PathParam("id")
        @ApiParam("Parameter id")
        String id,
        @QueryParam("deserializeValues")
    ...
    @Produces("application/json")
    @ApiOperation(value = "Get Variable", notes = "Operation Get Variable")
    public VariableValueDto getTaskGetLocalVariablesGetVariable(
        @PathParam("id")
        @ApiParam("Parameter id")
        String id,
        @PathParam("varId")
    ...
    public AttachmentDto getTaskGetAttachmentResourceAddAttachment(
        @PathParam("id")
        @ApiParam("Parameter id")
        String id,
    ...
    public List getTaskGetAttachmentResourceGetAttachments(
        @PathParam("id")
        @ApiParam("Parameter id")
        String id) {
    ...
    public AttachmentDto getTaskGetAttachmentResourceGetAttachment(
        @PathParam("id")
        @ApiParam("Parameter id")
        String id,
        @PathParam("attachmentId")
    ...
    public CommentDto getTaskGetTaskCommentResourceGetComment(
        @PathParam("id")
        @ApiParam("Parameter id")
        String id,
        @PathParam("commentId")
    ...
    public CommentDto getTaskGetTaskCommentResourceCreateComment(
        @PathParam("id")
        @ApiParam("Parameter id")
        String id,
        @ApiParam("Parameter uriInfo")
    ...
    public List getTaskGetTaskCommentResourceGetComments(
        @PathParam("id")
        @ApiParam("Parameter id")
        String id) {
    ...
    @Override
    public CountResultDto getTasksCount(
        @ApiParam("Parameter uriInfo")
        UriInfo uriInfo) {
    ...
    @Override
    public CountResultDto queryTasksCount(
        @ApiParam("Parameter taskQueryDto")
        TaskQueryDto taskQueryDto) {
